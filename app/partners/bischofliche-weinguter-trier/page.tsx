...
export const metadata = {
  title: 'Bischöfliche Weingüter Trier — Cork To Table',
  description: 'Two thousand years of Riesling. Bespoke wine tourism on the Mosel with Bischöfliche Weingüter Trier.',
}

export default function GermanyPage() {
  const partner = partners.find((p) => p.slug === 'bischofliche-weinguter-trier')!
      ...
      <section className="bg-burgundy py-20 px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="font-montserrat text-xs text-cream/70 leading-loose mb-8">
            Fill in your travel and wine preferences and we will build a Mosel journey around {partner.name} that fits you perfectly.
          </p>
